...
async function initializeNYakaCord() {
    try {
...
if (typeof window.__r === "undefined") {
    ...
    // NYakaCord delays the execution of index.ts(x) because NYakaCord's initialization is asynchronous
    ...
    // It is too late to late to hook __r, so we just initialize NYakaCord here
