...
(() => {
  ...
  var GITHUB, HTTP_REGEX, HTTP_REGEX_MULTI, BUNNY_PROXY_PREFIX, OFFICIAL_PLUGINS_REPO_URL, VD_PROXY_PREFIX, VD_DISCORD_SERVER_ID, VD_PLUGINS_CHANNEL_ID, VD_THEMES_CHANNEL_ID;
  var init_constants = __esm({
    "src/lib/utils/constants.ts"() {
      "use strict";
      init_asyncIteratorSymbol();
      init_promiseAllSettled();
      GITHUB = "https://github.com/Labakadu37/SilentVoid-Hub";
  ...
  var init_logger = __esm({
    "src/lib/utils/logger.ts"() {
      ...
      logger = new LoggerClass("NYakaCord");
    }
  });
  ...
  var init_background = __esm({
    "src/lib/addons/themes/colors/patches/background.tsx"() {
      ...
      init_logger();
      Messages = findByDisplayNameLazy("MessagesConnected");
    }
  });
  ...
  var init_settings = __esm({
    "src/lib/api/settings.ts"() {
      ...
      loaderConfig = wrapSync(createStorage(createFileBackend(getLoaderConfigPath(), {
        customLoadUrl: {
          enabled: false,
          url: "http://localhost:4040/nyakacord.js"
        }
      })));
    }
  });
  ...
  function onModuleRequire(moduleExports, id) {
    ...
    if (!patchedInspectSource && globalThis["__core-js_shared__"]) {
      var inspect2 = (f) => typeof f === "function" && functionToString.apply(f, []);
      globalThis["__core-js_shared__"].inspectSource = inspect2;
  ...
  // node_modules/@revenge-mod/devtools-shared/dist/constants.js
  var LogLevel, MessageType, MCPCommand, DEFAULT_SETTINGS, PROTOCOL_VERSION;
  ...
  function assembleStyles() {
    ...
    for (var [groupName, group] of Object.entries(styles)) {
      for (var [styleName, style] of Object.entries(group)) {
        styles[styleName] = {
          open: `\x1B[${style[0]}m`,
          close: `\x1B[${style[1]}m`
        };
    ...
    "node_modules/chalk/source/vendor/supports-color/browser.js"() {
      ...
      level = (() => {
        ...
        if (globalThis.navigator.userAgentData) {
          var brand = navigator.userAgentData.brands.find(({ brand: brand2 }) => brand2 === "Chromium");
  ...
  var _loop2, _loop1, stdoutColor, stderrColor, GENERATOR, STYLER, IS_EMPTY, levelMapping, styles2, applyOptions, chalkFactory, styleName, style, getModelAnsi, usedModels, model, proto, createStyler, createBuilder, applyStyle, chalk, chalkStderr, source_default;
  var init_source = __esm({
    "node_modules/chalk/source/index.js"() {
      ...
      init_browser();
      init_utilities();
      _loop2 = function(styleName, style) {
        styles2[styleName] = {
          get() {
      ...
      _loop1 = function(model) {
        styles2[model] = {
          get() {
            var { level: level2 } = this;
            return function(...arguments_) {
              var styler = createStyler(getModelAnsi(model, levelMapping[level2], "color", ...arguments_), ansi_styles_default.color.close, this[STYLER]);
        ...
        styles2[bgModel] = {
          get() {
            var { level: level2 } = this;
            return function(...arguments_) {
              var styler = createStyler(getModelAnsi(model, levelMapping[level2], "bgColor", ...arguments_), ansi_styles_default.bgColor.close, this[STYLER]);
              return createBuilder(this, styler, this[IS_EMPTY]);
            };
          }
        };
      ...
      chalkFactory = (options) => {
        var chalk2 = (...strings) => strings.join(" ");
        applyOptions(chalk2, options);
        Object.setPrototypeOf(chalk2, createChalk.prototype);
        return chalk2;
      };
      Object.setPrototypeOf(createChalk.prototype, Function.prototype);
      for ([styleName, style] of Object.entries(ansi_styles_default))
        _loop2(styleName, style);
      styles2.visible = {
        get() {
      ...
      createBuilder = (self, _styler, _isEmpty) => {
        var builder = (...arguments_) => applyStyle(builder, arguments_.length === 1 ? "" + arguments_[0] : arguments_.join(" "));
  ...
  function stringify_string(str) {
    ...
    for (var i = 0; i < len; i += 1) {
      var char = str[i];
      var replacement = get_escaped_char(char);
      if (replacement) {
  ...
  var init_utils2 = __esm({
    "node_modules/devalue/src/utils.js"() {
      ...
      init_constants3();
      DevalueError = /* @__PURE__ */ function(Error1) {
        "use strict";
        _inherits(DevalueError2, Error1);
        function DevalueError2(message, keys, value, root) {
          _class_call_check(this, DevalueError2);
          var _this;
          _this = _call_super(this, DevalueError2, [
            message
          ]);
          _this.name = "DevalueError";
          _this.path = keys.join("");
          _this.value = value;
          _this.root = root;
          return _this;
        }
        return DevalueError2;
  ...
  function unflatten(parsed, revivers2) {
    ...
    var hydrated = Array(values.length);
    var hydrating = null;
    function hydrate(index, standalone = false) {
      ...
      if (!value || typeof value !== "object") {
        ...
        if (typeof value[0] === "string") {
          var type = value[0];
          var reviver = revivers2 && Object.hasOwn(revivers2, type) ? revivers2[type] : void 0;
          if (reviver) {
            var i = value[1];
            if (typeof i !== "number") {
          ...
          switch (type) {
            ...
            case "Set":
              ...
              hydrated[index] = set;
              for (var i1 = 1; i1 < value.length; i1 += 1) {
                set.add(hydrate(value[i1]));
              }
              break;
            case "Map":
              var map = /* @__PURE__ */ new Map();
              hydrated[index] = map;
              for (var i2 = 1; i2 < value.length; i2 += 2) {
            ...
            case "null":
              ...
              hydrated[index] = obj;
              for (var i3 = 1; i3 < value.length; i3 += 2) {
                if (value[i3] === "__proto__") {
            ...
            case "DataView": {
              ...
              var TypedArrayConstructor = globalThis[type];
              var buffer2 = hydrate(value[1]);
            ...
            case "ArrayBuffer": {
              ...
              var arraybuffer = decode64(base64);
            ...
            case "Temporal.ZonedDateTime": {
              var temporalName = type.slice(9);
              hydrated[index] = Temporal[temporalName].from(value[1]);
              break;
            }
            case "URL": {
              var url2 = new URL(value[1]);
              hydrated[index] = url2;
              break;
            }
            case "URLSearchParams": {
              var url1 = new URLSearchParams(value[1]);
              hydrated[index] = url1;
              break;
            }
            default:
          ...
          for (var i4 = 2; i4 < value.length; i4 += 2) {
            var idx = value[i4];
            if (!is_valid_array_index(idx) || idx >= len) {
              throw new Error("Invalid input");
            }
            array[idx] = hydrate(value[i4 + 1]);
          }
          array.length = len;
        } else {
          var array1 = new Array(value.length);
          hydrated[index] = array1;
  ...
  function stringify(value, reducers2) {
    var stringified = run(false, value, reducers2);
    return typeof stringified === "string" ? stringified : `[${stringified.join(",")}]`;
  }
  function run(async, value, reducers2) {
    var stringified = [];
    var indexes = /* @__PURE__ */ new Map();
    var custom = [];
    if (reducers2) {
      for (var key of Object.getOwnPropertyNames(reducers2)) {
        custom.push({
          key,
          fn: reducers2[key]
        });
    ...
    function flatten(thing, index2) {
      ...
      for (var { key: key2, fn } of custom) {
        var _$value = fn(thing);
        if (_$value) {
          stringified[index2] = `["${key2}",${flatten(_$value)}]`;
          return index2;
        }
      }
      ...
      if (is_primitive(thing)) {
        ...
        str = Promise.resolve(thing).then((value2) => {
          var i2 = flatten(value2, index2);
          if (i2 < 0)
            stringified[index2] = i2;
        });
      } else {
        var type = get_type(thing);
        switch (type) {
          case "Number":
          case "String":
          case "Boolean":
          ...
          case "URLSearchParams":
            ...
            break;
          case "RegExp":
            var { source, flags } = thing;
            str = flags ? `["RegExp",${stringify_string(source)},"${flags}"]` : `["RegExp",${stringify_string(source)}]`;
            break;
          case "Array": {
            var mostly_dense = false;
            str = "[";
            for (var i = 0; i < thing.length; i += 1) {
              ...
              if (Object.hasOwn(thing, i)) {
                ...
                var populated_keys = valid_array_indices(
                  /** @type {any[]} */
                  thing
                );
                var population = populated_keys.length;
                var d = String(thing.length).length;
                var hole_cost = (thing.length - population) * 3;
                var sparse_cost = 4 + d + population * (d + 1);
                if (hole_cost > sparse_cost) {
                  str = "[" + SPARSE + "," + thing.length;
                  for (var j = 0; j < populated_keys.length; j++) {
                    var key1 = populated_keys[j];
                    keys.push(`[${key1}]`);
                    str += "," + key1 + "," + flatten(thing[key1]);
                    keys.pop();
                  }
                  break;
                } else {
          ...
          case "Set":
            str = '["Set"';
            for (var _$value1 of thing) {
              str += `,${flatten(_$value1)}`;
            }
            str += "]";
            break;
          case "Map":
            str = '["Map"';
            for (var [key22, _$value2] of thing) {
              keys.push(`.get(${is_primitive(key22) ? stringify_primitive(key22) : "..."})`);
              str += `,${flatten(key22)},${flatten(_$value2)}`;
              keys.pop();
            }
            str += "]";
            break;
          ...
          case "ArrayBuffer": {
            var arraybuffer = thing;
            var base64 = encode64(arraybuffer);
          ...
          default:
            ...
            if (Object.getPrototypeOf(thing) === null) {
              ...
              str = "{";
              var started = false;
              for (var key4 of Object.keys(thing)) {
                if (key4 === "__proto__") {
                  throw new DevalueError(`Cannot stringify objects with __proto__ keys`, keys, thing, value);
                }
                if (started)
                  str += ",";
                started = true;
                keys.push(stringify_key(key4));
                str += `${stringify_string(key4)}:${flatten(thing[key4])}`;
                keys.pop();
              }
              str += "}";
            }
  ...
  // node_modules/@revenge-mod/devtools-shared/dist/serializer.js
  ...
  function symbolKeyName(key, copy) {
    var base = `[Symbol(${key.description ?? ""})]`;
    var name = base;
    var index = 1;
    while (name in copy)
      name = `${base}#${index++}`;
  ...
  function previewAtCap(value) {
    try {
      ...
      if (value instanceof Map)
        return new MaxDepthObject(`[Map(${value.size})]`);
      if (value instanceof Set)
        return new MaxDepthObject(`[Set(${value.size})]`);
      var keys = Reflect.ownKeys(value).filter((k) => typeof k === "string");
      if (!keys.length)
        return new MaxDepthObject();
      var shown = keys.slice(0, 6);
      var ellipsis = keys.length > shown.length ? ", \u2026" : "";
  ...
  function snap(value, maxDepth, depth, seen) {
    ...
    if (typeof value === "function")
      return new MaxDepthFunction(functionName(value));
    if (typeof value !== "object")
      return value;
    ...
    if (depth >= maxDepth)
      return previewAtCap(value);
    if (value instanceof Map) {
      var copy$1 = /* @__PURE__ */ new Map();
      seen.set(value, copy$1);
      for (var [k, v2] of value)
        copy$1.set(snap(k, maxDepth, depth + 1, seen), snap(v2, maxDepth, depth + 1, seen));
      return copy$1;
    }
    if (value instanceof Set) {
      var copy$11 = /* @__PURE__ */ new Set();
      seen.set(value, copy$11);
      for (var v1 of value)
        copy$11.add(snap(v1, maxDepth, depth + 1, seen));
      return copy$11;
    }
    if (Array.isArray(value)) {
      var copy$12 = [];
      seen.set(value, copy$12);
      for (var i = 0; i < value.length; i++)
        try {
          copy$12[i] = snap(value[i], maxDepth, depth + 1, seen);
        } catch (unused) {
          copy$12[i] = new MaxDepthObject();
        }
      return copy$12;
    }
    if (isTagged(value))
    ...
    for (var key of Reflect.ownKeys(value)) {
      ...
      if ("value" in descriptor)
        ...
        if (depth + 1 >= maxDepth)
          child = hasGetter && hasSetter ? new MaxDepthGetterSetter(String(key)) : hasGetter ? new MaxDepthGetter(String(key)) : new MaxDepthSetter(String(key));
        else if (hasGetter)
          try {
      ...
      var name = typeof key === "symbol" ? symbolKeyName(key, copy) : key;
      copy[name] = child;
    }
    return copy;
  }
  ...
  var inspect, MaxDepthObject, MaxDepthFunction, MaxDepthGetter, MaxDepthSetter, MaxDepthGetterSetter, TaggedObject, reducers, revivers;
  var init_serializer = __esm({
    "node_modules/@revenge-mod/devtools-shared/dist/serializer.js"() {
      ...
      MaxDepthObject = /* @__PURE__ */ function() {
        "use strict";
        function MaxDepthObject2(preview) {
          _class_call_check(this, MaxDepthObject2);
          this.preview = preview;
        }
        _create_class(MaxDepthObject2, [
          {
            key: inspect,
            value: function value() {
              return source_default.cyan(this.preview ?? "[Object]");
            }
          },
          {
            key: "toString",
        ...
        return MaxDepthObject2;
      }();
      MaxDepthFunction = /* @__PURE__ */ function() {
        "use strict";
        function MaxDepthFunction2(name = "anonymous") {
          _class_call_check(this, MaxDepthFunction2);
          this.name = name;
        }
        _create_class(MaxDepthFunction2, [
          {
            key: inspect,
            value: function value() {
              return source_default.cyan(`[Function: ${this.name}]`);
            }
          },
          {
            key: "toString",
        ...
        return MaxDepthFunction2;
      }();
      MaxDepthGetter = /* @__PURE__ */ function() {
        "use strict";
        function MaxDepthGetter2(name) {
          _class_call_check(this, MaxDepthGetter2);
          this.name = name;
        }
        _create_class(MaxDepthGetter2, [
          {
            key: inspect,
            value: function value() {
              return source_default.cyan("[Getter]");
            }
          },
          {
            key: "toString",
        ...
        return MaxDepthGetter2;
      }();
      MaxDepthSetter = /* @__PURE__ */ function() {
        "use strict";
        function MaxDepthSetter2(name) {
          _class_call_check(this, MaxDepthSetter2);
          this.name = name;
        }
        _create_class(MaxDepthSetter2, [
          {
            key: inspect,
            value: function value() {
              return source_default.cyan("[Setter]");
            }
          },
          {
            key: "toString",
        ...
        return MaxDepthSetter2;
      }();
      MaxDepthGetterSetter = /* @__PURE__ */ function() {
        "use strict";
        function MaxDepthGetterSetter2(name) {
          _class_call_check(this, MaxDepthGetterSetter2);
          this.name = name;
        }
        _create_class(MaxDepthGetterSetter2, [
          {
            key: inspect,
            value: function value() {
              return source_default.cyan("[Getter/Setter]");
            }
          },
          {
            key: "toString",
        ...
        return MaxDepthGetterSetter2;
      }();
      TaggedObject = /* @__PURE__ */ function() {
        "use strict";
        function TaggedObject2(tag) {
          _class_call_check(this, TaggedObject2);
          this.tag = tag;
        }
        _create_class(TaggedObject2, [
          {
            key: inspect,
            value: function value() {
              return source_default.cyan(this.tag);
            }
          },
          {
            key: "toString",
      ...
      reducers = {
        MaxDepthObject: (v2) => v2 instanceof MaxDepthObject && [
          v2.preview ?? null
        ],
        MaxDepthFunction: (v2) => v2 instanceof MaxDepthFunction && [
          v2.name
        ],
        MaxDepthGetter: (v2) => v2 instanceof MaxDepthGetter && [
          v2.name
        ],
        MaxDepthSetter: (v2) => v2 instanceof MaxDepthSetter && [
          v2.name
        ],
        MaxDepthGetterSetter: (v2) => v2 instanceof MaxDepthGetterSetter && [
          v2.name
        ],
        TaggedObject: (v2) => v2 instanceof TaggedObject && [
          v2.tag
        ],
        URL: (v2) => typeof URL !== "undefined" && v2 instanceof URL && [
          v2.href
        ],
        symbol: (v2) => typeof v2 === "symbol" && [
          v2.description ?? ""
        ],
        function: (v2) => typeof v2 === "function" && [
          functionName(v2)
        ],
        instance: (v2) => {
          ...
          var proto2;
          try {
            proto2 = Object.getPrototypeOf(v2);
          } catch (unused) {
            return [
              {}
            ];
          ...
          if (proto2 === Object.prototype || proto2 === Array.prototype || proto2 === null)
            return false;
          if (v2 instanceof Date || v2 instanceof RegExp || v2 instanceof Map || v2 instanceof Set)
            return false;
          return [
            {
              ...v2
  ...
  // node_modules/bippy/dist/src-DnJsD_Sy.js
  function traverseFiber(fiber, selector, ascending = false) {
    var isAsync = fiber && selector(fiber) instanceof Promise;
    if (isAsync)
      return traverseFiberAsync(fiber, selector, ascending);
    return traverseFiberSync(fiber, selector, ascending);
  }
  var version, BIPPY_INSTRUMENTATION_STRING, objectDefineProperty, objectHasOwnProperty, NO_OP, checkDCE, isRealReactDevtools, isReactRefreshOverride, injectFnStr, isReactRefresh, onActiveListeners, _renderers, installRDTHook, patchRDTHook, hasRDTHook, getRDTHook, isClientEnvironment, safelyInstallRDTHook, FunctionComponentTag, ClassComponentTag, HostRootTag, HostComponentTag, HostTextTag, FragmentTag, ContextConsumerTag, ForwardRefTag, SuspenseComponentTag, MemoComponentTag, SimpleMemoComponentTag, LazyComponentTag, DehydratedSuspenseComponentTag, SuspenseListComponentTag, OffscreenComponentTag, LegacyHiddenComponentTag, HostHoistableTag, HostSingletonTag, ActivityComponentTag, ViewTransitionComponentTag, CONCURRENT_MODE_NUMBER, ELEMENT_TYPE_SYMBOL_STRING, TRANSITIONAL_ELEMENT_TYPE_SYMBOL_STRING, CONCURRENT_MODE_SYMBOL_STRING, DEPRECATED_ASYNC_MODE_SYMBOL_STRING, PerformedWork, Placement, Hydrating, Update, Cloned, ChildDeletion, ContentReset, Snapshot, Visibility, MutationMask, isValidElement, isValidFiber, isHostFiber, isCompositeFiber, areFiberEqual, traverseContexts, traverseState, traverseProps, didFiberRender, didFiberCommit, getMutatedHostFibers, getFiberStack, shouldFilterFiber, getNearestHostFiber, getNearestHostFibers, traverseFiberSync, traverseFiberAsync, getTimings, hasMemoCache, getType, getDisplayName, detectReactBuildType, isInstrumentationActive, getLatestFiber, fiberId, fiberIdMap, setFiberId, getFiberId, mountFiberRecursively, updateFiberRecursively, unmountFiber, unmountFiberChildrenRecursively, commitId, rootInstanceMap, traverseRenderedFibers, createFiberVisitor, _overrideProps, _overrideHookState, _overrideContext, injectOverrideMethods, isPOJO, buildPathsFromValue, overrideProps, overrideHookState, overrideContext, instrument, getFiberFromHostInstance, INSTALL_ERROR, _fiberRoots, secure, onCommitFiberRoot;
  var init_src_DnJsD_Sy = __esm({
    "node_modules/bippy/dist/src-DnJsD_Sy.js"() {
      init_asyncIteratorSymbol();
      init_promiseAllSettled();
      init_async_to_generator();
      version = "0.3.34";
      BIPPY_INSTRUMENTATION_STRING = `bippy-${version}`;
      ...
      checkDCE = (fn) => {
        try {
          var code = Function.prototype.toString.call(fn);
          if (code.indexOf("^_^") > -1)
            setTimeout(() => {
      ...
      isRealReactDevtools = (rdtHook = getRDTHook()) => {
        return "getFiberRoots" in rdtHook;
      };
      isReactRefreshOverride = false;
      injectFnStr = void 0;
      isReactRefresh = (rdtHook = getRDTHook()) => {
        if (isReactRefreshOverride)
          return true;
        if (typeof rdtHook.inject === "function")
          injectFnStr = rdtHook.inject.toString();
        return Boolean(injectFnStr?.includes("(injected)"));
      };
      onActiveListeners = /* @__PURE__ */ new Set();
      _renderers = /* @__PURE__ */ new Set();
      installRDTHook = (onActive) => {
        ...
        try {
          objectDefineProperty(globalThis, "__REACT_DEVTOOLS_GLOBAL_HOOK__", {
            ...
            set(newHook) {
              if (newHook && typeof newHook === "object") {
                var ourRenderers = rdtHook.renderers;
                rdtHook = newHook;
          ...
          var originalWindowHasOwnProperty = globalThis.hasOwnProperty;
          var hasRanHack = false;
          objectDefineProperty(globalThis, "hasOwnProperty", {
            configurable: true,
      ...
      patchRDTHook = (onActive) => {
        ...
        try {
          var rdtHook = globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__;
          if (!rdtHook)
            return;
          if (!rdtHook._instrumentationSource) {
            var isReactDevtools = isRealReactDevtools();
            ...
            var prevInject = rdtHook.inject;
            if (isReactRefresh(rdtHook) && !isReactDevtools) {
              isReactRefreshOverride = true;
              var nextID = rdtHook.inject({
                scheduleRefresh() {
                }
              });
              if (nextID)
          ...
          if (rdtHook.renderers.size || rdtHook._instrumentationIsActive || isReactRefresh())
            onActive?.();
        } catch (unused) {
        }
      };
      ...
      isClientEnvironment = () => {
        return Boolean(typeof globalThis !== "undefined" && (globalThis.document?.createElement || globalThis.navigator?.product === "ReactNative"));
      };
      ...
      LazyComponentTag = 16;
      DehydratedSuspenseComponentTag = 18;
      SuspenseListComponentTag = 19;
      OffscreenComponentTag = 22;
      LegacyHiddenComponentTag = 23;
      HostHoistableTag = 26;
      HostSingletonTag = 27;
      ActivityComponentTag = 28;
      ViewTransitionComponentTag = 30;
      CONCURRENT_MODE_NUMBER = 60111;
      ELEMENT_TYPE_SYMBOL_STRING = "Symbol(react.element)";
      TRANSITIONAL_ELEMENT_TYPE_SYMBOL_STRING = "Symbol(react.transitional.element)";
      ...
      Snapshot = 1024;
      Visibility = 8192;
      MutationMask = Placement | Update | ChildDeletion | ContentReset | Hydrating | Visibility | Snapshot;
      isValidElement = (element) => typeof element === "object" && element != null && "$$typeof" in element && [
        ELEMENT_TYPE_SYMBOL_STRING,
        TRANSITIONAL_ELEMENT_TYPE_SYMBOL_STRING
      ].includes(String(element.$$typeof));
      isValidFiber = (fiber) => typeof fiber === "object" && fiber != null && "tag" in fiber && "stateNode" in fiber && "return" in fiber && "child" in fiber && "sibling" in fiber && "flags" in fiber;
      isHostFiber = (fiber) => {
        switch (fiber.tag) {
      ...
      areFiberEqual = (fiberA, fiberB) => {
        return fiberA === fiberB || fiberA.alternate === fiberB || fiberB.alternate === fiberA;
      };
      traverseContexts = (fiber, selector) => {
        try {
          var nextDependencies = fiber.dependencies;
          var prevDependencies = fiber.alternate?.dependencies;
          if (!nextDependencies || !prevDependencies)
            return false;
          if (typeof nextDependencies !== "object" || !("firstContext" in nextDependencies) || typeof prevDependencies !== "object" || !("firstContext" in prevDependencies))
            return false;
          var nextContext = nextDependencies.firstContext;
          var prevContext = prevDependencies.firstContext;
      ...
      traverseState = (fiber, selector) => {
        try {
          var nextState = fiber.memoizedState;
          var prevState = fiber.alternate?.memoizedState;
          while (nextState || prevState) {
            if (selector(nextState, prevState) === true)
              return true;
      ...
      traverseProps = (fiber, selector) => {
        try {
          var nextProps = fiber.memoizedProps;
          var prevProps = fiber.alternate?.memoizedProps || {};
          var allKeys = /* @__PURE__ */ new Set([
            ...Object.keys(nextProps),
            ...Object.keys(prevProps)
          ]);
          for (var propName of allKeys) {
            var prevValue = prevProps?.[propName];
            var nextValue = nextProps?.[propName];
            if (selector(propName, nextValue, prevValue) === true)
              return true;
          }
        } catch (unused) {
        }
      ...
      didFiberRender = (fiber) => {
        var nextProps = fiber.memoizedProps;
        var prevProps = fiber.alternate?.memoizedProps || {};
        var flags = fiber.flags ?? fiber.effectTag ?? 0;
        switch (fiber.tag) {
          case ClassComponentTag:
      ...
      shouldFilterFiber = (fiber) => {
        switch (fiber.tag) {
          ...
          case HostRootTag:
            return false;
          default: {
            var symbolOrNumber = typeof fiber.type === "object" && fiber.type !== null ? fiber.type.$$typeof : fiber.type;
            var typeSymbol = typeof symbolOrNumber === "symbol" ? symbolOrNumber.toString() : symbolOrNumber;
            switch (typeSymbol) {
      ...
      getNearestHostFiber = (fiber, ascending = false) => {
        var hostFiber = traverseFiber(fiber, isHostFiber, ascending);
        if (!hostFiber)
      ...
      traverseFiberSync = (fiber, selector, ascending = false) => {
        if (!fiber)
          return null;
        ...
        while (child) {
          var match = traverseFiberSync(child, selector, ascending);
          if (match)
            return match;
      ...
      traverseFiberAsync = (fiber, selector, ascending = false) => _async_to_generator(function* () {
        if (!fiber)
          return null;
        if ((yield selector(fiber)) === true)
          return fiber;
        var child = ascending ? fiber.return : fiber.child;
        while (child) {
          var match = yield traverseFiberAsync(child, selector, ascending);
          if (match)
            return match;
          child = ascending ? null : child.sibling;
        }
      ...
      getTimings = (fiber) => {
        var totalTime = fiber?.actualDuration ?? 0;
        var selfTime = totalTime;
        var child = fiber?.child ?? null;
      ...
      getType = (type) => {
        ...
        if (typeof currentType === "object" && currentType)
          return getType(currentType.type || currentType.render);
        return null;
      };
      getDisplayName = (type) => {
        var currentType = type;
        ...
        if (typeof currentType !== "function" && !(typeof currentType === "object" && currentType))
          return null;
        var name = currentType.displayName || currentType.name || null;
        if (name)
          return name;
        var unwrappedType = getType(currentType);
        if (!unwrappedType)
          return null;
      ...
      getLatestFiber = (fiber) => {
        ...
        for (var root of _fiberRoots) {
          var latestFiber = traverseFiber(root.current, (innerFiber) => {
            if (innerFiber === fiber)
              return true;
          });
          if (latestFiber)
      ...
      fiberId = 0;
      fiberIdMap = /* @__PURE__ */ new WeakMap();
      setFiberId = (fiber, id = fiberId++) => {
        fiberIdMap.set(fiber, id);
      };
      getFiberId = (fiber) => {
        var id = fiberIdMap.get(fiber);
      ...
      mountFiberRecursively = (onRender, firstChild, traverseSiblings) => {
        ...
        while (fiber != null) {
          ...
          if (fiber.tag === SuspenseComponentTag) {
            ...
            if (isTimedOut) {
              ...
              var areSuspenseChildrenConditionallyWrapped = OffscreenComponentTag === -1;
      ...
      updateFiberRecursively = (onRender, nextFiber, prevFiber, parentFiber) => {
        ...
        var isSuspense = nextFiber.tag === SuspenseComponentTag;
        ...
        if (prevDidTimeout && nextDidTimeOut) {
          var nextFallbackChildSet = nextFiber.child?.sibling ?? null;
          var prevFallbackChildSet = prevFiber.child?.sibling ?? null;
          ...
          var nextFallbackChildSet1 = nextFiber.child?.sibling ?? null;
          if (nextFallbackChildSet1 !== null)
            mountFiberRecursively(onRender, nextFallbackChildSet1, true);
      ...
      unmountFiber = (onRender, fiber) => {
        var isRoot = fiber.tag === HostRootTag;
        if (isRoot || !shouldFilterFiber(fiber))
          onRender(fiber, "unmount");
      };
      unmountFiberChildrenRecursively = (onRender, fiber) => {
        var isTimedOutSuspense = fiber.tag === SuspenseComponentTag && fiber.memoizedState !== null;
        var child = fiber.child;
        if (isTimedOutSuspense) {
          var primaryChildFragment = fiber.child;
          var fallbackChildFragment = primaryChildFragment?.sibling ?? null;
      ...
      commitId = 0;
      rootInstanceMap = /* @__PURE__ */ new WeakMap();
      traverseRenderedFibers = (root, onRender) => {
        var fiber = "current" in root ? root.current : root;
        var rootInstance = rootInstanceMap.get(root);
        if (!rootInstance) {
          rootInstance = {
            id: commitId++,
            prevFiber: null
        ...
        var { prevFiber } = rootInstance;
        if (!fiber)
          unmountFiber(onRender, fiber);
        else if (prevFiber !== null) {
          var wasMounted = prevFiber && prevFiber.memoizedState != null && prevFiber.memoizedState.element != null && prevFiber.memoizedState.isDehydrated !== true;
          var isMounted = fiber.memoizedState != null && fiber.memoizedState.element != null && fiber.memoizedState.isDehydrated !== true;
      ...
      createFiberVisitor = ({ onRender }) => {
        return (_rendererID, root, _state) => {
          traverseRenderedFibers(root, onRender);
        };
      };
      _overrideProps = null;
      _overrideHookState = null;
      _overrideContext = null;
      injectOverrideMethods = () => {
        var _loop3 = function(_3, renderer2) {
          try {
            if (_overrideHookState) {
              var prevOverrideHookState = _overrideHookState;
              _overrideHookState = (fiber, id, path, value) => {
                var current = fiber.memoizedState;
                ...
                renderer2.overrideHookState?.(fiber, id, path, value);
              };
            } else if (renderer2.overrideHookState)
              _overrideHookState = renderer2.overrideHookState;
            if (_overrideProps) {
              var prevOverrideProps = _overrideProps;
              _overrideProps = (fiber, path, value) => {
                prevOverrideProps(fiber, path, value);
                renderer2.overrideProps?.(fiber, path, value);
              };
            } else if (renderer2.overrideProps)
              _overrideProps = renderer2.overrideProps;
        ...
        for (var [_2, renderer] of Array.from(rdtHook.renderers))
          _loop3(_2, renderer);
      };
      isPOJO = (maybePOJO) => {
      ...
      buildPathsFromValue = (maybePOJO, basePath = []) => {
        if (!isPOJO(maybePOJO))
          return [
            {
              path: basePath,
        ...
        var paths = [];
        for (var key in maybePOJO) {
          var value = maybePOJO[key];
      ...
      overrideProps = (fiber, partialValue) => {
        injectOverrideMethods();
        var paths = buildPathsFromValue(partialValue);
        for (var { path, value } of paths)
          try {
            _overrideProps?.(fiber, path, value);
          } catch (unused) {
          }
      };
      overrideHookState = (fiber, id, partialValue) => {
        injectOverrideMethods();
        var hookId = String(id);
      ...
      overrideContext = (fiber, contextType, partialValue) => {
        injectOverrideMethods();
        if (isPOJO(partialValue)) {
          var paths = buildPathsFromValue(partialValue);
          for (var { path, value } of paths)
      ...
      instrument = (options) => {
        var rdtHook = getRDTHook(options.onActive);
        rdtHook._instrumentationSource = options.name ?? BIPPY_INSTRUMENTATION_STRING;
        var prevOnCommitFiberRoot = rdtHook.onCommitFiberRoot;
        if (options.onCommitFiberRoot) {
          var handler = (rendererID, root, priority) => {
            if (rdtHook.onCommitFiberRoot !== handler)
              return;
        ...
        var prevOnCommitFiberUnmount = rdtHook.onCommitFiberUnmount;
        if (options.onCommitFiberUnmount) {
          var handler1 = (rendererID, root) => {
            if (rdtHook.onCommitFiberUnmount !== handler1)
              return;
            prevOnCommitFiberUnmount?.(rendererID, root);
            options.onCommitFiberUnmount?.(rendererID, root);
          };
          rdtHook.onCommitFiberUnmount = handler1;
        }
        var prevOnPostCommitFiberRoot = rdtHook.onPostCommitFiberRoot;
        if (options.onPostCommitFiberRoot) {
          var handler2 = (rendererID, root) => {
            if (rdtHook.onPostCommitFiberRoot !== handler2)
              return;
            prevOnPostCommitFiberRoot?.(rendererID, root);
            options.onPostCommitFiberRoot?.(rendererID, root);
          };
          rdtHook.onPostCommitFiberRoot = handler2;
        }
        return rdtHook;
      };
      getFiberFromHostInstance = (hostInstance) => {
        var rdtHook = getRDTHook();
        for (var renderer of rdtHook.renderers.values())
          try {
        ...
        if (typeof hostInstance === "object" && hostInstance != null) {
          ...
          for (var key in hostInstance)
            if (key.startsWith("__reactContainer$") || key.startsWith("__reactInternalInstance$") || key.startsWith("__reactFiber"))
              return hostInstance[key] || null;
        }
        return null;
      };
      INSTALL_ERROR = new Error();
      _fiberRoots = /* @__PURE__ */ new Set();
      secure = (options, secureOptions = {}) => {
        var onActive = options.onActive;
        var isRDTHookInstalled = hasRDTHook();
        var isUsingRealReactDevtools = isRealReactDevtools();
        var isUsingReactRefresh = isReactRefresh();
        var timeout;
        var isDevelopment = !secureOptions.isProduction;
        options.onActive = () => {
          ...
          try {
            var rdtHook = getRDTHook();
            for (var renderer of rdtHook.renderers.values()) {
              var [majorVersion] = renderer.version.split(".");
              if (Number(majorVersion) < (secureOptions.minReactMajorVersion ?? 17))
                isSecure = false;
              var buildType = detectReactBuildType(renderer);
          ...
          onActive?.();
          try {
            var onCommitFiberRoot$1 = options.onCommitFiberRoot;
            if (onCommitFiberRoot$1)
              options.onCommitFiberRoot = (rendererID, root, priority) => {
            ...
            var onCommitFiberUnmount = options.onCommitFiberUnmount;
            ...
            var onPostCommitFiberRoot = options.onPostCommitFiberRoot;
      ...
      onCommitFiberRoot = (handler) => {
        return instrument(secure({
          onCommitFiberRoot: (_2, root) => {
            handler(root);
          }
        }));
      };
  ...
  // node_modules/bippy/dist/index.js
  var dist_exports = {};
  __export(dist_exports, {
    ActivityComponentTag: () => ActivityComponentTag,
    BIPPY_INSTRUMENTATION_STRING: () => BIPPY_INSTRUMENTATION_STRING,
    CONCURRENT_MODE_NUMBER: () => CONCURRENT_MODE_NUMBER,
    CONCURRENT_MODE_SYMBOL_STRING: () => CONCURRENT_MODE_SYMBOL_STRING,
    ClassComponentTag: () => ClassComponentTag,
    ContextConsumerTag: () => ContextConsumerTag,
    DEPRECATED_ASYNC_MODE_SYMBOL_STRING: () => DEPRECATED_ASYNC_MODE_SYMBOL_STRING,
    DehydratedSuspenseComponentTag: () => DehydratedSuspenseComponentTag,
    ELEMENT_TYPE_SYMBOL_STRING: () => ELEMENT_TYPE_SYMBOL_STRING,
    ForwardRefTag: () => ForwardRefTag,
    FragmentTag: () => FragmentTag,
    FunctionComponentTag: () => FunctionComponentTag,
    HostComponentTag: () => HostComponentTag,
    HostHoistableTag: () => HostHoistableTag,
    HostRootTag: () => HostRootTag,
    HostSingletonTag: () => HostSingletonTag,
    HostTextTag: () => HostTextTag,
    INSTALL_ERROR: () => INSTALL_ERROR,
    LazyComponentTag: () => LazyComponentTag,
    LegacyHiddenComponentTag: () => LegacyHiddenComponentTag,
    MemoComponentTag: () => MemoComponentTag,
    OffscreenComponentTag: () => OffscreenComponentTag,
    SimpleMemoComponentTag: () => SimpleMemoComponentTag,
    SuspenseComponentTag: () => SuspenseComponentTag,
    SuspenseListComponentTag: () => SuspenseListComponentTag,
    TRANSITIONAL_ELEMENT_TYPE_SYMBOL_STRING: () => TRANSITIONAL_ELEMENT_TYPE_SYMBOL_STRING,
    ViewTransitionComponentTag: () => ViewTransitionComponentTag,
    _fiberRoots: () => _fiberRoots,
    _renderers: () => _renderers,
    areFiberEqual: () => areFiberEqual,
    ...
    fiberIdMap: () => fiberIdMap,
    getDisplayName: () => getDisplayName,
    getFiberFromHostInstance: () => getFiberFromHostInstance,
    ...
    hasRDTHook: () => hasRDTHook,
    injectOverrideMethods: () => injectOverrideMethods,
    ...
    isReactRefresh: () => isReactRefresh,
    isRealReactDevtools: () => isRealReactDevtools,
    isValidElement: () => isValidElement,
    isValidFiber: () => isValidFiber,
    mountFiberRecursively: () => mountFiberRecursively,
    onCommitFiberRoot: () => onCommitFiberRoot,
    overrideContext: () => overrideContext,
    overrideHookState: () => overrideHookState,
    overrideProps: () => overrideProps,
    patchRDTHook: () => patchRDTHook,
    safelyInstallRDTHook: () => safelyInstallRDTHook,
    secure: () => secure,
    setFiberId: () => setFiberId,
    shouldFilterFiber: () => shouldFilterFiber,
    traverseContexts: () => traverseContexts,
    traverseFiber: () => traverseFiber,
    traverseFiberAsync: () => traverseFiberAsync,
    traverseFiberSync: () => traverseFiberSync,
    traverseProps: () => traverseProps,
    traverseRenderedFibers: () => traverseRenderedFibers,
    traverseState: () => traverseState,
    unmountFiber: () => unmountFiber,
    unmountFiberChildrenRecursively: () => unmountFiberChildrenRecursively,
    updateFiberRecursively: () => updateFiberRecursively,
    version: () => version
  });
  ...
  // node_modules/@revenge-mod/devtools-client/dist/index.js
  function loadBippy() {
    bippyModule ??= Promise.resolve().then(() => (init_dist2(), dist_exports));
    return bippyModule;
  }
  var _class, bippyModule, LOG_BUFFER_CAPACITY, DevToolsClient;
  var init_dist3 = __esm({
    "node_modules/@revenge-mod/devtools-client/dist/index.js"() {
      ...
      init_serializer();
      bippyModule = null;
      LOG_BUFFER_CAPACITY = 1e3;
      DevToolsClient = (_class = /* @__PURE__ */ function() {
        "use strict";
        function _class6() {
          _class_call_check(this, _class6);
          _define_property(this, "ws", null);
          _define_property(this, "settings", DEFAULT_SETTINGS.client);
          _define_property(this, "scope", {
            devTools: this,
            vars: {
              mcp: {}
            }
          ...
          _define_property(this, "authenticated", false);
          _define_property(this, "handlers", /* @__PURE__ */ new Map());
          _define_property(this, "alias", void 0);
          _define_property(this, "logs", []);
          _define_property(this, "reactRoot", null);
          _define_property(this, "reactCommitHooked", false);
          _define_property(this, "patches", /* @__PURE__ */ new Map());
          _define_property(this, "patchIdCounter", 0);
        }
        _create_class(_class6, [
          {
            /**
            ...
            */
            key: "connect",
            value: function connect(url2, info, alias) {
          ...
          },
          {
            ...
            */
            key: "expose",
            value: function expose(key, value) {
              this.scope[key] = value;
            }
          },
          {
            key: "sendHello",
            value: function sendHello(info) {
              var msg = {
          ...
          },
          {
            ...
            value: function handleMessage(msg) {
              ...
              var handlers = this.handlers.get(msg.type);
              if (handlers)
          ...
          {
            key: "handleRun",
            value: function handleRun(msg) {
              try {
                var mappings = msg.data.mappings || {};
                var scope = {
                  ...this.scope
                };
                for (var [key, mapping] of Object.entries(mappings))
                  scope[key] = this.resolveMapping(mapping);
                var result = this.evalInScope(msg.data.code, scope);
          ...
          {
            key: "wrapCodeWithAutoReturn",
            value: function wrapCodeWithAutoReturn(code) {
              var trimmed = code.trim();
              if (trimmed.startsWith("return "))
                return code;
              if (!/[;{}]|^(let|const|var|if|for|while|function|class)\s/.test(trimmed))
                return `return (${trimmed})`;
              var lines = trimmed.split(/[;\n]+/).map((l) => l.trim()).filter(Boolean);
              if (!lines.length)
                return code;
              var lastLine = lines[lines.length - 1];
              var previousLines = lines.slice(0, -1);
              if (/^(let|const|var|if|for|while|function|class|return)\s/.test(lastLine))
                return code;
              var statementsCode = previousLines.join("\n");
...
return (${lastLine})` : `return (${lastLine})`;
          ...
          {
            key: "withScope",
            value: function withScope(scope, code) {
              return new Function(...Object.keys(scope), code);
            }
          },
          {
            key: "resolveMapping",
            value: function resolveMapping(path) {
              try {
          ...
          },
          {
            ...
            */
            key: "evalInScope",
            value: function evalInScope(code, scope = this.scope) {
              ...
              if (!func)
                throw new SyntaxError(`${this.cleanParseError(parseError)} (code is evaluated as an expression first, then as a function body \u2014 use an explicit \`return\` for multi-statement code)`);
          ...
          },
          {
            ...
            key: "cleanParseError",
            value: function cleanParseError(e) {
          ...
          },
          {
            ...
            value: function formatError(e) {
              ...
              var firstFrame = lines.findIndex((line) => /^\s*at /.test(line));
              if (firstFrame === -1)
                return stack;
              var frames = lines.slice(firstFrame);
              if (frames.length <= 5)
                return stack;
              return [
          ...
          },
          {
            ...
            */
            key: "evalExpression",
            value: function evalExpression(code) {
          ...
          },
          {
            key: "revengeDiscord",
            get: function get() {
              var discord = this.revenge?.discord;
              if (!discord)
                throw new Error("Revenge Discord API is not available in the client scope");
              return discord;
            }
          },
          {
            key: "revengeModulesFinders",
            get: function get() {
              var finders = this.revenge?.modules?.finders;
              if (!finders)
                throw new Error("Revenge module finders are not available in the client scope");
              return finders;
            }
          },
          {
            key: "sendMCPResult",
            value: function sendMCPResult(id, ok, result, error) {
              var msg = {
          ...
          {
            key: "handleMCPRun",
            value: function handleMCPRun(msg) {
              return _async_to_generator(function* () {
                var { id, command, args } = msg.data;
                try {
                  var result;
                  switch (command) {
                    case MCPCommand.GetModules:
                      result = yield this.mcpGetModules(args);
                      break;
                    ...
                    case MCPCommand.DiscordFluxListen:
                      result = yield this.mcpDiscordFluxListen(args);
                      break;
                    ...
                    case MCPCommand.ReactTreeGetRoot:
                      result = yield this.mcpReactTreeGetRoot();
                      break;
                    case MCPCommand.ReactTreeMatch:
                      result = yield this.mcpReactTreeMatch(args);
                      break;
                    case MCPCommand.ReactTreeTraverseStructure:
                      result = yield this.mcpReactTreeTraverseStructure(args);
                      break;
                    case MCPCommand.ReactTreeHooks:
                      result = yield this.mcpReactTreeHooks(args);
                      break;
                    default:
          ...
          {
            key: "mcpGetModules",
            value: function mcpGetModules(args) {
              var finders = this.revengeModulesFinders;
              var filterFactory = finders.filters[args.filter];
              if (typeof filterFactory !== "function")
                throw new Error(`Unknown filter "${args.filter}". Available: ${Object.keys(finders.filters).join(", ")}`);
              var filterArgs = this.evalInScope(args.args);
              if (!Array.isArray(filterArgs))
                throw new Error("`args` must evaluate to an array of filter arguments");
              var filter = filterFactory(...filterArgs);
              var max = args.max ?? 1;
              var timeout = args.timeout ?? 5e3;
              var depth = args.depth ?? this.settings.log.inspectDepth;
          ...
          {
            key: "mcpLookupModules",
            value: function mcpLookupModules(args) {
              var finders = this.revengeModulesFinders;
              var filterFactory = finders.filters[args.filter];
              if (typeof filterFactory !== "function")
                throw new Error(`Unknown filter "${args.filter}". Available: ${Object.keys(finders.filters).join(", ")}`);
              ...
              if (!Array.isArray(filterArgs))
                throw new Error("`args` must evaluate to an array of filter arguments");
              var filter = filterFactory(...filterArgs);
              var initialize = args.initialize ?? true;
              var depth = args.depth ?? this.settings.log.inspectDepth;
              var max = args.max ?? Infinity;
              var options = initialize ? void 0 : {
                initialize: false
              };
              var modules = [];
              for (var [exports, id] of finders.lookupModules(filter, options)) {
                modules.push({
                  id,
          ...
          {
            key: "mcpRequireModule",
            value: function mcpRequireModule(args) {
              var depth = args.depth ?? this.settings.log.inspectDepth;
              var metroRequire2 = globalThis.__r;
              if (typeof metroRequire2 !== "function")
                throw new Error("Metro require function is not available");
              var exports = metroRequire2(args.id);
              return {
                id: args.id,
                exports: snapshot(exports, depth),
          ...
          {
            key: "mcpSaveVar",
            value: function mcpSaveVar(args) {
              var value = this.evalInScope(args.expression);
          ...
          },
          {
            ...
            key: "storePatch",
            value: function storePatch(unpatch) {
              var id = ++this.patchIdCounter;
          ...
          },
          {
            ...
            key: "removePatch",
            value: function removePatch(id) {
              var unpatch = this.patches.get(id);
              if (!unpatch)
                throw new Error(`Unknown patch ID: ${id}`);
              unpatch();
          ...
          {
            key: "mcpUnpatchMethod",
            value: function mcpUnpatchMethod(args) {
              return this.removePatch(args.id);
            }
          },
          {
            key: "mcpEval",
            value: function mcpEval(args) {
              return snapshot(this.evalInScope(args.code), this.settings.log.inspectDepth);
            }
          },
          {
            key: "mcpDiscordReload",
            value: function mcpDiscordReload() {
              var manager = this.revengeDiscord.native?.BundleUpdaterManager;
          ...
          {
            key: "mcpDiscordFluxListen",
            value: function mcpDiscordFluxListen(args) {
              var flux = this.revengeDiscord.flux;
              if (!flux?.onAnyFluxEventDispatched || !flux.onFluxEventDispatched)
                throw new Error("Revenge Discord Flux API is not available");
              var count = args.count ?? 25;
              var timeout = args.timeout ?? 5e3;
              var depth = args.depth ?? this.settings.log.inspectDepth;
              return new Promise((resolve) => {
                var events = [];
          ...
          {
            key: "mcpDiscordFluxPatch",
            value: function mcpDiscordFluxPatch(args) {
              var flux = this.revengeDiscord.flux;
              if (!flux?.onAnyFluxEventDispatched || !flux.onFluxEventDispatched)
                throw new Error("Revenge Discord Flux API is not available");
              var hook = this.evalExpression(args.hook);
              if (typeof hook !== "function")
                throw new Error("`hook` must evaluate to a function");
              var unsub = args.event ? flux.onFluxEventDispatched(args.event, hook) : flux.onAnyFluxEventDispatched(hook);
              return {
                id: this.storePatch(unsub)
              };
            }
          },
          {
            key: "mcpDiscordFluxUnpatch",
            value: function mcpDiscordFluxUnpatch(args) {
              return this.removePatch(args.id);
            }
          },
          {
            key: "mcpGetLogs",
            value: function mcpGetLogs(args) {
              var minLevel = args.min_level ?? LogLevel.Debug;
              var depth = args.depth ?? this.settings.log.inspectDepth;
              var entries = this.logs.filter((entry) => entry.level >= minLevel);
          ...
          {
            key: "ensureReactCommitHook",
            value: function ensureReactCommitHook(bippy) {
              if (this.reactCommitHooked)
                return;
          ...
          {
            key: "getReactRootFiber",
            value: function getReactRootFiber(bippy) {
              this.ensureReactCommitHook(bippy);
              var hook = bippy.getRDTHook();
              if (typeof hook?.getFiberRoots === "function") {
                for (var id of hook.renderers.keys())
                  for (var root of hook.getFiberRoots(id))
                    if (root?.current)
                      return root.current;
              }
              if (this.reactRoot)
          ...
          {
            key: "resolveReactFiber",
            value: function resolveReactFiber(bippy, from) {
              if (from != null) {
                var fiber = this.evalInScope(from);
                if (!bippy.isValidFiber(fiber))
                  throw new Error("`from` must evaluate to a React fiber");
                return fiber;
              }
              var stored = this.scope.vars.mcp?.reactFiber;
              if (stored != null) {
          ...
          {
            key: "describeFiber",
            value: function describeFiber(bippy, fiber) {
              return {
          ...
          {
            key: "mcpReactTreeGetRoot",
            value: function mcpReactTreeGetRoot() {
              return _async_to_generator(function* () {
                var bippy = yield loadBippy();
                var root = this.getReactRootFiber(bippy);
                this.scope.vars.mcp ??= {};
          ...
          {
            key: "mcpReactTreeMatch",
            value: function mcpReactTreeMatch(args) {
              return _async_to_generator(function* () {
                var bippy = yield loadBippy();
                var predicate = this.evalExpression(args.predicate);
                if (typeof predicate !== "function")
                  throw new Error("`predicate` must evaluate to a function");
                var start = this.resolveReactFiber(bippy, args.from);
                var maxVisits = args.depth ?? 100;
                var visited = 0;
                var exceeded = false;
                var found = bippy.traverseFiber(start, (fiber) => {
          ...
          {
            key: "summarizeProps",
            value: function summarizeProps(props) {
          ...
          {
            key: "mcpReactTreeTraverseStructure",
            value: function mcpReactTreeTraverseStructure(args) {
              return _async_to_generator(function* () {
                var bippy = yield loadBippy();
                var start = this.resolveReactFiber(bippy, args.from);
                var maxDepth = args.depth ?? 10;
                var showHost = args.showHostComponents ?? false;
                var maxLines = 2e3;
                var lines = [];
                var truncated = false;
                var formatLine = (fiber, depth) => {
                  var { name, key } = this.describeFiber(bippy, fiber);
                  var host = showHost && bippy.isHostFiber(fiber) ? " (host)" : "";
                  var keyPart = key != null ? ` key=${JSON.stringify(key)}` : "";
                  var props = this.summarizeProps(fiber.memoizedProps);
                  var propsPart = props ? ` ${props}` : "";
                  return `${"  ".repeat(depth)}<${name}${keyPart}${propsPart}>${host}`;
                };
                var walk = (node, depth) => {
                  for (var fiber = node; fiber; fiber = fiber.sibling) {
          ...
          {
            key: "mcpReactTreeHooks",
            value: function mcpReactTreeHooks(args) {
              return _async_to_generator(function* () {
                var bippy = yield loadBippy();
                var fiber = this.resolveReactFiber(bippy, args.from);
                var limit = args.limit ?? 50;
                var depth = args.depth ?? this.settings.log.inspectDepth;
                var first = fiber.memoizedState;
                var isHookNode = (node2) => node2 != null && typeof node2 === "object" && ("memoizedState" in node2 || "queue" in node2) && "next" in node2;
                if (!isHookNode(first))
                  return {
                    count: 0,
                    hooks: [],
                ...
                var truncated = false;
                var index = 0;
                for (var node = first; isHookNode(node); node = node.next) {
          ...
          },
          {
            ...
            */
            key: "log",
            value: function log(level2, message) {
              var snapped = message.map((item) => snapshot(item, this.settings.log.inspectDepth));
              this.logs.push({
                level: level2,
                time: Date.now(),
                message: snapped
              });
              if (this.logs.length > LOG_BUFFER_CAPACITY)
                this.logs.shift();
              if (!this.authenticated)
                return;
              if (level2 < this.settings.log.level)
                return;
              var msg = {
      ...
      _define_property(_class, "version", PROTOCOL_VERSION), _class);
    }
  });
  ...
  var init_default = __esm({
    "src/core/i18n/default.json"() {
      default_default = {
        ...
        LINKS: "Links",
        LOAD_FROM_CUSTOM_URL_DEC: "Load NYakaCord from a custom endpoint",
        ...
        UNINSTALL: "Uninstall",
        URL_PLACEHOLDER: "https://github.com/Labakadu37/SilentVoid-Hub",
        VERSION: "Version",
        VERSIONS: "Versions"
      };
    }
  ...
  // src/lib/api/debug/devtools.ts
  function interceptLogging() {
    var _loop3 = function(key2, level3) {
      unpatches.push(instead(key2, console, (args, orig) => {
        if (dtConnected && dtClient)
          dtClient.log(level3, args);
  ...
  function connectDt(url2, quiet) {
    if (dtClient)
      return;
    var info = getDebugInfo();
    var client = dtClient = new DevToolsClient();
    client.connect(`ws://${url2}`, `${info.discord.version} (${info.bunny.loader.name}-${info.bunny.loader.version})`);
    var ws = client.ws;
    ws.addEventListener("open", () => {
      if (!quiet)
        showToast("Connected to DevTools", findAssetId("CheckmarkSmallIcon"));
      if (client.settings.log.interceptConsole) {
        var unintercept = interceptLogging();
  ...
  function disconnectDt() {
    dtClient?.disconnect();
  }
  function useIsDtConnected() {
    var [connected, update] = React2.useState(dtConnected);
    React2.useEffect(() => {
  ...
  var dtClient, dtConnected, changeHooks, intercepted;
  ...
  // src/lib/api/debug/react.ts
  function bump2() {
    for (var x2 of changeHooks2)
      x2(rdtConnected);
  }
  function cleanup2() {
    rdtClient = null;
  ...
  function connectRdt(url2, quiet) {
    ...
    globalThis[getReactDevToolsProp() || "__vendetta_rdc"].connectToDevTools({
      websocket: ws
    });
  }
  ...
  function useIsRdtConnected() {
    ...
    React.useEffect(() => {
      changeHooks2.add(update);
      return () => void changeHooks2.delete(update);
    });
    return connected;
  }
  var rdtPort, rdtClient, rdtConnected, changeHooks2;
  var init_react = __esm({
    "src/lib/api/debug/react.ts"() {
      ...
      rdtClient = null;
      rdtConnected = false;
      changeHooks2 = /* @__PURE__ */ new Set();
    }
  });

  // src/lib/api/debug/index.ts
  var debug_exports = {};
  __export(debug_exports, {
    connectToDebugger: () => connectToDebugger,
    connectToReactDevTools: () => connectToReactDevTools,
  ...
  function connectToDebugger(url2, quiet) {
    if (dtConnected)
      return;
    connectDt(url2, quiet);
  }
  function connectToReactDevTools(url2, quiet) {
    if (!isReactDevToolsPreloaded() || rdtConnected)
      return;
    connectRdt(url2, quiet);
  }
  ...
  function initDebugger() {
    if (!settings.enableAutoDebugger || !settings.debuggerUrl)
      return;
    try {
  ...
  var import_react_native6, versionHash;
  ...
  function convertHermesStack(stack) {
    ...
    for (var entry of stack.entries) {
      ...
      var { location, functionName: functionName2 } = entry;
      if (location.type === "NATIVE" || location.type === "INTERNAL_BYTECODE") {
        continue;
      }
      frames.push({
        methodName: functionName2,
            ...
            /* @__PURE__ */ jsxs(import_react_native15.View, {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx(Text, {
                  ...
                  children: "A crash occurred while rendering a component. This could be caused by a plugin, NYakaCord, or Discord itself."
                }),
                /* @__PURE__ */ jsxs(Text, {
  ...
  // src/assets/icons/nyakacord.png
  var nyakacord_default;
  var init_nyakacord = __esm({
    "src/assets/icons/nyakacord.png"() {
  ...
  function Version({ label, version: version2, icon }) {
    return /* @__PURE__ */ jsx(TableRow, {
      ...
      onPress: () => {
        clipboard.setString(`${label} - ${version2}`);
    ...
    "node_modules/fuzzysort/fuzzysort.js"(exports, module) {
      ...
      ((root, UMD) => {
              ...
              for (var i = 0; i < targetsLen; ++i) {
                ...
                if (containsSpace)
                  for (var i1 = 0; i1 < preparedSearch.spaceSearches.length; i1++)
                    keysSpacesBestScores[i1] = NEGATIVE_INFINITY2;
                for (var keyI = 0; keyI < keysLen; ++keyI) {
                  ...
                  if (containsSpace)
                    for (var i2 = 0; i2 < preparedSearch.spaceSearches.length; i2++) {
                      if (allowPartialMatchScores[i2] > -1e3) {
                        if (keysSpacesBestScores[i2] > NEGATIVE_INFINITY2) {
                ...
                if (containsSpace) {
                  for (var i3 = 0; i3 < preparedSearch.spaceSearches.length; i3++) {
                    if (keysSpacesBestScores[i3] === NEGATIVE_INFINITY2)
                      continue outer;
                  }
                } else {
                  var hasAtLeast1Match = false;
                  for (var i4 = 0; i4 < keysLen; i4++) {
                    if (tmpResults[i4]._score !== NEGATIVE_INFINITY2) {
                ...
                if (containsSpace) {
                  ...
                  var score = NEGATIVE_INFINITY2;
                  for (var i7 = 0; i7 < keysLen; i7++) {
                    var result = objResults[i7];
                    if (result._score > -1e3) {
                      if (score > NEGATIVE_INFINITY2) {
        ...
        var new_result = (target, options) => {
          ...
          result._score = options._score ?? NEGATIVE_INFINITY2;
          ...
          if (options?.key) {
            ...
            for (var i = 0; i < targets.length; i++) {
              ...
              for (var keyI = options.keys.length - 1; keyI >= 0; --keyI) {
                ...
                if (!isPrepared(target))
                  target = getPrepared(target);
                target._score = NEGATIVE_INFINITY2;
                target._indexes.len = 0;
                objResults[keyI] = target;
              }
              objResults.obj = obj;
              objResults._score = NEGATIVE_INFINITY2;
        ...
        var algorithmSpaces = (preparedSearch, target, allowPartialMatch) => {
          ...
          for (var i = 0; i < searchesLen; ++i) {
            allowPartialMatchScores[i] = NEGATIVE_INFINITY2;
        ...
        var remove_accents = (str) => str.replace(RegExp("[\\u0041-\\u005A\\u0061-\\u007A\\u00AA\\u00BA\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02B8\\u02E0-\\u02E4\\u1D00-\\u1D25\\u1D2C-\\u1D5C\\u1D62-\\u1D65\\u1D6B-\\u1D77\\u1D79-\\u1DBE\\u1E00-\\u1EFF\\u2071\\u207F\\u2090-\\u209C\\u212A-\\u212B\\u2132\\u214E\\u2160-\\u2188\\u2C60-\\u2C7F\\uA722-\\uA787\\uA78B-\\uA7DC\\uA7F1-\\uA7FF\\uAB30-\\uAB5A\\uAB5C-\\uAB64\\uAB66-\\uAB69\\uFB00-\\uFB06\\uFF21-\\uFF3A\\uFF41-\\uFF5A\\u{10780}-\\u{10785}\\u{10787}-\\u{107B0}\\u{107B2}-\\u{107BA}\\u{1DF00}-\\u{1DF1E}\\u{1DF25}-\\u{1DF2A}]+", "gu"), (match) => match.normalize("NFD")).replace(/[\u0300-\u036f]/g, "");
        ...
        var NEGATIVE_INFINITY2 = -INFINITY;
        var noResults = [];
        noResults.total = 0;
        var NULL = null;
  ...
  var import_fuzzysort, import_react4, import_react_native18, showSimpleActionSheet, hideActionSheet;
  ...
  var import_chroma_js4, import_react5, import_react_native19, CardContext, useCardContext, Actions;
        ...
        evalPlugin(plugin) {
          return _async_to_generator(function* () {
            var vendettaForPlugins = {
              ...
              logger: new LoggerClass(`NYakaCord \xBB ${plugin.manifest.name}`)
            };
...
//# sourceURL=${plugin.id}`;
  ...
  var import_react6, useBadgesModule, badges_default;
      ...
      badges_default = defineCorePlugin({
        ...
        start() {
          ...
          after("default", useBadgesModule, ([user], r) => {
            var [badges, setBadges] = (0, import_react6.useState)(user ? badgeCache[user.userId] ??= [] : []);
    ...
    "src/core/commands/debug.ts"() {
      ...
      debug_default = () => ({
        ...
        execute([ephemeral], ctx) {
          var info = getDebugInfo();
          var content = [
            "**NYakaCord Debug Info**",
            `> NYakaCord: ${info.bunny.version} (${info.bunny.loader.name} ${info.bunny.loader.version})`,
  ...
  var init_focusManager = __esm({
    "node_modules/@tanstack/query-core/build/modern/focusManager.js"() {
      ...
      FocusManager = (_focused = /* @__PURE__ */ new WeakMap(), _cleanup = /* @__PURE__ */ new WeakMap(), _setup = /* @__PURE__ */ new WeakMap(), /* @__PURE__ */ function(Subscribable2) {
        "use strict";
        _inherits(_class6, Subscribable2);
        function _class6() {
          _class_call_check(this, _class6);
          var _this;
          _this = _call_super(this, _class6), _class_private_field_init(_this, _focused, {
            writable: true,
            value: void 0
  ...
  var init_timeoutManager = __esm({
    "node_modules/@tanstack/query-core/build/modern/timeoutManager.js"() {
      ...
      TimeoutManager = (_provider = /* @__PURE__ */ new WeakMap(), _providerCalled = /* @__PURE__ */ new WeakMap(), /* @__PURE__ */ function() {
        "use strict";
        function _class6() {
          _class_call_check(this, _class6);
          ...
          _class_private_field_init(this, _providerCalled, {
            writable: true,
            value: false
          });
        }
        _create_class(_class6, [
          {
            ...
            value: function setTimeoutProvider(provider) {
              if (true) {
                if (_class_private_field_get(this, _providerCalled) && provider !== _class_private_field_get(this, _provider)) {
                  console.error(`[timeoutManager]: Switching provider after calls to previous provider might result in unexpected behavior.`, {
                    previous: _class_private_field_get(this, _provider),
                    provider
                  });
                }
              }
              ...
              if (true) {
                _class_private_field_set(this, _providerCalled, false);
              }
            }
          },
          {
            ...
            value: function setTimeout1(callback, delay) {
              if (true) {
                _class_private_field_set(this, _providerCalled, true);
              }
              return _class_private_field_get(this, _provider).setTimeout(callback, delay);
            }
          },
          {
            key: "clearTimeout",
            value: function clearTimeout1(timeoutId) {
              _class_private_field_get(this, _provider).clearTimeout(timeoutId);
            }
          },
          {
            key: "setInterval",
            value: function setInterval1(callback, delay) {
              ...
              return _class_private_field_get(this, _provider).setInterval(callback, delay);
            }
          },
          {
            key: "clearInterval",
            value: function clearInterval1(intervalId) {
              _class_private_field_get(this, _provider).clearInterval(intervalId);
            }
          }
        ]);
        return _class6;
  ...
  function partialMatchKey(a, b3) {
    ...
    if (a && b3 && typeof a === "object" && typeof b3 === "object") {
      return Object.keys(b3).every((key) => partialMatchKey(a[key], b3[key]));
    }
    return false;
  }
  function replaceEqualDeep(a, b3, depth = 0) {
    if (a === b3) {
      return a;
    }
    if (depth > 500)
    ...
    for (var i = 0; i < bSize; i++) {
      ...
      var v2 = replaceEqualDeep(aItem, bItem, depth + 1);
      copy[key] = v2;
      if (v2 === aItem)
        equalItems++;
    }
    ...
    "node_modules/@tanstack/query-core/build/modern/onlineManager.js"() {
      ...
      OnlineManager = (_online = /* @__PURE__ */ new WeakMap(), _cleanup2 = /* @__PURE__ */ new WeakMap(), _setup2 = /* @__PURE__ */ new WeakMap(), /* @__PURE__ */ function(Subscribable2) {
        ...
        function _class6() {
          _class_call_check(this, _class6);
          var _this;
          _this = _call_super(this, _class6), _class_private_field_init(_this, _online, {
            writable: true,
            value: true
  ...
  function createRetryer(config) {
    ...
    var isResolved = () => thenable.status !== "pending";
    ...
    var run2 = () => {
      ...
      Promise.resolve(promiseOrValue).then(resolve).catch((error) => {
        ...
        var retry = config.retry ?? (environmentManager.isServer() ? 0 : 3);
        ...
        _create_class(_class6, [
          ...
          },
          {
            ...
            value: function scheduleGc() {
              ...
              if (isValidTimeout(this.gcTime)) {
                _class_private_field_set(this, _gcTimeout, timeoutManager.setTimeout(() => {
                  this.optionalRemove();
                }, this.gcTime));
              }
            }
          },
          {
            ...
            value: function updateGcTime(newGcTime) {
              this.gcTime = Math.max(this.gcTime || 0, newGcTime ?? (environmentManager.isServer() ? Infinity : 5 * 60 * 1e3));
            }
          },
          {
            key: "clearGcTimeout",
            value: function clearGcTimeout() {
              if (_class_private_field_get(this, _gcTimeout) !== void 0) {
                timeoutManager.clearTimeout(_class_private_field_get(this, _gcTimeout));
  ...
  function infiniteQueryBehavior(pages) {
    return {
      onFetch: (context, query) => {
        ...
        var currentPage = 0;
        var fetchFn = () => _async_to_generator(function* () {
          var cancelled = false;
          var addSignalProperty = (object) => {
            addConsumeAwareSignal(object, () => context.signal, () => cancelled = true);
          };
          var queryFn = ensureQueryFn(context.options, context.fetchOptions);
          var fetchPage = (data, param2, previous2) => _async_to_generator(function* () {
            if (cancelled) {
    ...
    var reducer = (state) => {
      switch (action.type) {
        ...
        case "success":
          ...
          _class_private_field_set(this, _revertState, action.manual ? newState : void 0);
          return newState;
        case "error":
  ...
  var _queryType, _initialState, _revertState, _cache, _client, _retryer, _defaultOptions, _abortSignalConsumed, _isInitialPausedFetch, _dispatch, _class2, Query;
  var init_query = __esm({
    "node_modules/@tanstack/query-core/build/modern/query.js"() {
      ...
      Query = (_queryType = /* @__PURE__ */ new WeakMap(), _initialState = /* @__PURE__ */ new WeakMap(), _revertState = /* @__PURE__ */ new WeakMap(), _cache = /* @__PURE__ */ new WeakMap(), _client = /* @__PURE__ */ new WeakMap(), _retryer = /* @__PURE__ */ new WeakMap(), _defaultOptions = /* @__PURE__ */ new WeakMap(), _abortSignalConsumed = /* @__PURE__ */ new WeakMap(), _isInitialPausedFetch = /* @__PURE__ */ new WeakSet(), _dispatch = /* @__PURE__ */ new WeakSet(), _class2 = /* @__PURE__ */ function(Removable2) {
        "use strict";
        _inherits(_class6, Removable2);
        function _class6(config) {
          _class_call_check(this, _class6);
          var _this;
          _this = _call_super(this, _class6), _class_private_method_init(_this, _isInitialPausedFetch), _class_private_method_init(_this, _dispatch), _class_private_field_init(_this, _queryType, {
            writable: true,
            value: void 0
          }), _class_private_field_init(_this, _initialState, {
            writable: true,
            value: void 0
            ...
            writable: true,
            value: void 0
          }), _class_private_field_init(_this, _client, {
            writable: true,
            value: void 0
          ...
          _this.observers = [];
          _class_private_field_set(_this, _client, config.client);
          _class_private_field_set(_this, _cache, _class_private_field_get(_this, _client).getQueryCache());
        ...
        _create_class(_class6, [
          ...
          },
          {
            key: "queryType",
            get: function get() {
              return _class_private_field_get(this, _queryType);
            }
          },
          {
            key: "promise",
          ...
          },
          {
            ...
            value: function setOptions(options) {
              ...
              if (options?._type) {
                _class_private_field_set(this, _queryType, options._type);
              }
              ...
              if (this.state && this.state.data === void 0) {
                ...
                if (defaultState.data !== void 0) {
                  ...
                  _class_private_field_set(this, _initialState, defaultState);
                }
              }
            }
          },
          ...
          },
          {
            key: "destroy",
            value: function destroy() {
              _get(_get_prototype_of(_class6.prototype), "destroy", this).call(this);
              this.cancel({
                silent: true
              });
            }
          },
          {
            key: "resetState",
            get: function get() {
              return _class_private_field_get(this, _initialState);
            }
          },
          {
            key: "reset",
              ...
              if (this.observers.includes(observer)) {
                ...
                if (!this.observers.length) {
                  if (_class_private_field_get(this, _retryer)) {
                    if (_class_private_field_get(this, _abortSignalConsumed) || _class_private_method_get(this, _isInitialPausedFetch, isInitialPausedFetch).call(this)) {
          ...
          },
          {
            ...
            value: function fetch2(options, fetchOptions) {
              return _async_to_generator(function* () {
                ...
                _class_private_field_get(this, _retryer)?.status() !== "rejected") {
                ...
                var fetchFn = () => {
                  ...
                  var createQueryFnContext = () => {
                    var queryFnContext2 = {
                      client: _class_private_field_get(this, _client),
                ...
                var behavior = _class_private_field_get(this, _queryType) === "infinite" ? infiniteQueryBehavior(this.options.pages) : this.options.behavior;
                ...
                try {
                  var data = yield _class_private_field_get(this, _retryer).start();
                  if (data === void 0) {
                    if (true) {
  ...
  function updateStaleTimeout() {
    ...
    if (environmentManager.isServer() || _class_private_field_get(this, _currentResult).isStale || !isValidTimeout(staleTime)) {
      return;
    }
    var time = timeUntilStale(_class_private_field_get(this, _currentResult).dataUpdatedAt, staleTime);
    var timeout = time + 1;
    _class_private_field_set(this, _staleTimeoutId, timeoutManager.setTimeout(() => {
  ...
  function updateRefetchInterval(nextInterval) {
    ...
    if (environmentManager.isServer() || resolveQueryBoolean(this.options.enabled, _class_private_field_get(this, _currentQuery)) === false || !isValidTimeout(_class_private_field_get(this, _currentRefetchInterval)) || _class_private_field_get(this, _currentRefetchInterval) === 0) {
      return;
    }
    _class_private_field_set(this, _refetchIntervalId, timeoutManager.setInterval(() => {
  ...
  function clearStaleTimeout() {
    if (_class_private_field_get(this, _staleTimeoutId) !== void 0) {
      timeoutManager.clearTimeout(_class_private_field_get(this, _staleTimeoutId));
      _class_private_field_set(this, _staleTimeoutId, void 0);
    }
  }
  function clearRefetchInterval() {
    if (_class_private_field_get(this, _refetchIntervalId) !== void 0) {
      timeoutManager.clearInterval(_class_private_field_get(this, _refetchIntervalId));
      _class_private_field_set(this, _refetchIntervalId, void 0);
    }
  }
  function updateQuery() {
    var query = _class_private_field_get(this, _client2).getQueryCache().build(_class_private_field_get(this, _client2), this.options);
  ...
  function notify(notifyOptions) {
    notifyManager.batch(() => {
      ...
      _class_private_field_get(this, _client2).getQueryCache().notify({
  ...
  var init_queryObserver = __esm({
    "node_modules/@tanstack/query-core/build/modern/queryObserver.js"() {
      ...
      init_utils3();
      init_timeoutManager();
      QueryObserver = (_client2 = /* @__PURE__ */ new WeakMap(), _currentQuery = /* @__PURE__ */ new WeakMap(), _currentQueryInitialState = /* @__PURE__ */ new WeakMap(), _currentResult = /* @__PURE__ */ new WeakMap(), _currentResultState = /* @__PURE__ */ new WeakMap(), _currentResultOptions = /* @__PURE__ */ new WeakMap(), _currentThenable = /* @__PURE__ */ new WeakMap(), _selectError = /* @__PURE__ */ new WeakMap(), _selectFn = /* @__PURE__ */ new WeakMap(), _selectResult = /* @__PURE__ */ new WeakMap(), _lastQueryWithDefinedData = /* @__PURE__ */ new WeakMap(), _staleTimeoutId = /* @__PURE__ */ new WeakMap(), _refetchIntervalId = /* @__PURE__ */ new WeakMap(), _currentRefetchInterval = /* @__PURE__ */ new WeakMap(), _trackedProps = /* @__PURE__ */ new WeakMap(), _executeFetch = /* @__PURE__ */ new WeakSet(), _updateStaleTimeout = /* @__PURE__ */ new WeakSet(), _computeRefetchInterval = /* @__PURE__ */ new WeakSet(), _updateRefetchInterval = /* @__PURE__ */ new WeakSet(), _updateTimers = /* @__PURE__ */ new WeakSet(), _clearStaleTimeout = /* @__PURE__ */ new WeakSet(), _clearRefetchInterval = /* @__PURE__ */ new WeakSet(), _updateQuery = /* @__PURE__ */ new WeakSet(), _notify = /* @__PURE__ */ new WeakSet(), _class3 = /* @__PURE__ */ function(Subscribable2) {
        "use strict";
        _inherits(_class6, Subscribable2);
        function _class6(client, options) {
          _class_call_check(this, _class6);
          var _this;
          _this = _call_super(this, _class6), _class_private_method_init(_this, _executeFetch), _class_private_method_init(_this, _updateStaleTimeout), _class_private_method_init(_this, _computeRefetchInterval), _class_private_method_init(_this, _updateRefetchInterval), _class_private_method_init(_this, _updateTimers), _class_private_method_init(_this, _clearStaleTimeout), _class_private_method_init(_this, _clearRefetchInterval), _class_private_method_init(_this, _updateQuery), _class_private_method_init(_this, _notify), _class_private_field_init(_this, _client2, {
            writable: true,
            value: void 0
            ...
            writable: true,
            value: void 0
          }), _class_private_field_init(_this, _currentThenable, {
            writable: true,
            value: void 0
          ...
          _class_private_field_set(_this, _currentThenable, pendingThenable());
          _this.bindMethods();
        ...
        _create_class(_class6, [
          ...
          },
          {
            ...
            value: function setOptions(options) {
              ...
              var prevQuery = _class_private_field_get(this, _currentQuery);
              this.options = _class_private_field_get(this, _client2).defaultQueryOptions(options);
              if (this.options.enabled !== void 0 && typeof this.options.enabled !== "boolean" && typeof this.options.enabled !== "function" && typeof resolveQueryBoolean(this.options.enabled, _class_private_field_get(this, _currentQuery)) !== "boolean") {
              ...
              this.updateResult();
              if (mounted && (_class_private_field_get(this, _currentQuery) !== prevQuery || resolveQueryBoolean(this.options.enabled, _class_private_field_get(this, _currentQuery)) !== resolveQueryBoolean(prevOptions.enabled, _class_private_field_get(this, _currentQuery)) || resolveStaleTime(this.options.staleTime, _class_private_field_get(this, _currentQuery)) !== resolveStaleTime(prevOptions.staleTime, _class_private_field_get(this, _currentQuery)))) {
                _class_private_method_get(this, _updateStaleTimeout, updateStaleTimeout).call(this);
              }
              var nextRefetchInterval = _class_private_method_get(this, _computeRefetchInterval, computeRefetchInterval).call(this);
              if (mounted && (_class_private_field_get(this, _currentQuery) !== prevQuery || resolveQueryBoolean(this.options.enabled, _class_private_field_get(this, _currentQuery)) !== resolveQueryBoolean(prevOptions.enabled, _class_private_field_get(this, _currentQuery)) || nextRefetchInterval !== _class_private_field_get(this, _currentRefetchInterval))) {
          ...
          },
          {
            ...
            value: function getOptimisticResult(options) {
              var query = _class_private_field_get(this, _client2).getQueryCache().build(_class_private_field_get(this, _client2), options);
            ...
            value: function trackResult(result, onPropTracked) {
              return new Proxy(result, {
                get: (target, key) => {
                  ...
                  if (key === "promise") {
                    this.trackProp("data");
                    if (!this.options.experimental_prefetchInRender && _class_private_field_get(this, _currentThenable).status === "pending") {
                      _class_private_field_get(this, _currentThenable).reject(new Error("experimental_prefetchInRender feature flag is not enabled"));
                    }
                  }
          ...
          },
          {
            ...
            value: function fetchOptimistic2(options) {
              var defaultedOptions = _class_private_field_get(this, _client2).defaultQueryOptions(options);
              var query = _class_private_field_get(this, _client2).getQueryCache().build(_class_private_field_get(this, _client2), defaultedOptions);
          ...
          },
          {
            ...
            value: function createResult(query, options) {
              ...
              if (options.select && data !== void 0 && !skipSelect) {
                if (prevResult && data === prevResultState?.data && options.select === _class_private_field_get(this, _selectFn)) {
              ...
              var result = {
                ...
                promise: _class_private_field_get(this, _currentThenable),
              ...
              if (this.options.experimental_prefetchInRender) {
                ...
                var recreateThenable = () => {
                  var pending = _class_private_field_set(this, _currentThenable, nextResult.promise = pendingThenable());
                  finalizeThenableIfPossible(pending);
                };
                var prevThenable = _class_private_field_get(this, _currentThenable);
  ...
  var _client3, _observers, _mutationCache, _retryer2, _dispatch2, _class4, Mutation;
  var init_mutation = __esm({
    "node_modules/@tanstack/query-core/build/modern/mutation.js"() {
      ...
      init_removable();
      init_retryer();
      Mutation = (_client3 = /* @__PURE__ */ new WeakMap(), _observers = /* @__PURE__ */ new WeakMap(), _mutationCache = /* @__PURE__ */ new WeakMap(), _retryer2 = /* @__PURE__ */ new WeakMap(), _dispatch2 = /* @__PURE__ */ new WeakSet(), _class4 = /* @__PURE__ */ function(Removable2) {
        "use strict";
        _inherits(_class6, Removable2);
        function _class6(config) {
          _class_call_check(this, _class6);
          var _this;
          _this = _call_super(this, _class6), _class_private_method_init(_this, _dispatch2), _class_private_field_init(_this, _client3, {
            writable: true,
            value: void 0
          }), _class_private_field_init(_this, _observers, {
            writable: true,
            value: void 0
          ...
          _class_private_field_set(_this, _client3, config.client);
        ...
        _create_class(_class6, [
          ...
          },
          {
            ...
            value: function execute(variables) {
              return _async_to_generator(function* () {
                var onContinue = () => {
                  _class_private_method_get(this, _dispatch2, dispatch2).call(this, {
                    type: "continue"
                  });
                };
                var mutationFnContext = {
                  client: _class_private_field_get(this, _client3),
                  meta: this.options.meta,
                  mutationKey: this.options.mutationKey
                };
                _class_private_field_set(this, _retryer2, createRetryer({
                  fn: () => {
                  ...
                  canRun: () => _class_private_field_get(this, _mutationCache).canRun(this)
                }));
                var restored = this.state.status === "pending";
                var isPaused = !_class_private_field_get(this, _retryer2).canStart();
                try {
                  if (restored) {
                    onContinue();
                  } else {
                    ...
                    if (_class_private_field_get(this, _mutationCache).config.onMutate) {
                      yield _class_private_field_get(this, _mutationCache).config.onMutate(variables, this, mutationFnContext);
                    }
                    var context = yield this.options.onMutate?.(variables, mutationFnContext);
                  ...
                  var data = yield _class_private_field_get(this, _retryer2).start();
                  yield _class_private_field_get(this, _mutationCache).config.onSuccess?.(data, variables, this.state.context, this, mutationFnContext);
                  yield this.options.onSuccess?.(data, variables, this.state.context, mutationFnContext);
                  yield _class_private_field_get(this, _mutationCache).config.onSettled?.(data, null, this.state.variables, this.state.context, this, mutationFnContext);
                  yield this.options.onSettled?.(data, null, variables, this.state.context, mutationFnContext);
                  _class_private_method_get(this, _dispatch2, dispatch2).call(this, {
                    type: "success",
                    data
                  });
                  ...
                  try {
                    yield _class_private_field_get(this, _mutationCache).config.onError?.(error, variables, this.state.context, this, mutationFnContext);
                  } catch (e) {
                    void Promise.reject(e);
                  }
                  try {
                    yield this.options.onError?.(error, variables, this.state.context, mutationFnContext);
                  } catch (e) {
                    void Promise.reject(e);
                  }
                  try {
                    yield _class_private_field_get(this, _mutationCache).config.onSettled?.(void 0, error, this.state.variables, this.state.context, this, mutationFnContext);
                  } catch (e) {
                    void Promise.reject(e);
                  }
                  try {
                    yield this.options.onSettled?.(void 0, error, variables, this.state.context, mutationFnContext);
                  } catch (e) {
                    void Promise.reject(e);
                  }
                  _class_private_method_get(this, _dispatch2, dispatch2).call(this, {
                  ...
                  _class_private_field_get(this, _mutationCache).runNext(this);
                }
              }).call(this);
            }
          }
  ...
  var init_mutationCache = __esm({
    "node_modules/@tanstack/query-core/build/modern/mutationCache.js"() {
      ...
      init_utils3();
      init_subscribable();
      MutationCache = (_mutations = /* @__PURE__ */ new WeakMap(), _scopes = /* @__PURE__ */ new WeakMap(), _mutationId = /* @__PURE__ */ new WeakMap(), /* @__PURE__ */ function(Subscribable2) {
        "use strict";
        _inherits(_class6, Subscribable2);
        function _class6(config = {}) {
          _class_call_check(this, _class6);
          var _this;
          _this = _call_super(this, _class6), _class_private_field_init(_this, _mutations, {
            writable: true,
            value: void 0
          }), _class_private_field_init(_this, _scopes, {
            writable: true,
            value: void 0
          ...
          _this.config = config;
          _class_private_field_set(_this, _mutations, /* @__PURE__ */ new Set());
          _class_private_field_set(_this, _scopes, /* @__PURE__ */ new Map());
          _class_private_field_set(_this, _mutationId, 0);
          return _this;
        }
        _create_class(_class6, [
          {
          ...
          },
          {
            ...
            value: function add(mutation) {
              _class_private_field_get(this, _mutations).add(mutation);
              var scope = scopeFor(mutation);
              if (typeof scope === "string") {
                var scopedMutations = _class_private_field_get(this, _scopes).get(scope);
                if (scopedMutations) {
                  scopedMutations.push(mutation);
                } else {
                  _class_private_field_get(this, _scopes).set(scope, [
                    mutation
                  ]);
                }
              }
          ...
          },
          {
            ...
            value: function remove(mutation) {
              if (_class_private_field_get(this, _mutations).delete(mutation)) {
                var scope = scopeFor(mutation);
                if (typeof scope === "string") {
                  var scopedMutations = _class_private_field_get(this, _scopes).get(scope);
                  if (scopedMutations) {
                    if (scopedMutations.length > 1) {
                      ...
                      _class_private_field_get(this, _scopes).delete(scope);
                    }
                  }
                }
              }
          ...
          },
          {
            ...
            value: function canRun(mutation) {
              var scope = scopeFor(mutation);
              if (typeof scope === "string") {
                var mutationsWithSameScope = _class_private_field_get(this, _scopes).get(scope);
                var firstPendingMutation = mutationsWithSameScope?.find((m2) => m2.state.status === "pending");
          ...
          },
          {
            ...
            value: function runNext(mutation) {
              var scope = scopeFor(mutation);
              if (typeof scope === "string") {
                var foundMutation = _class_private_field_get(this, _scopes).get(scope)?.find((m2) => m2 !== mutation && m2.state.isPaused);
          ...
          },
          {
            ...
            value: function clear() {
              notifyManager.batch(() => {
                _class_private_field_get(this, _mutations).forEach((mutation) => {
                  this.notify({
                    type: "removed",
                    mutation
                  });
                });
                _class_private_field_get(this, _mutations).clear();
                _class_private_field_get(this, _scopes).clear();
              });
            }
          },
          {
            ...
            value: function getAll() {
              return Array.from(_class_private_field_get(this, _mutations));
            }
          },
          {
            key: "find",
  ...
  function notify2(action) {
    notifyManager.batch(() => {
      if (_class_private_field_get(this, _mutateOptions) && this.hasListeners()) {
        ...
        var onMutateResult = _class_private_field_get(this, _currentResult2).context;
        var context = {
          client: _class_private_field_get(this, _client4),
          meta: this.options.meta,
          mutationKey: this.options.mutationKey
        };
        if (action?.type === "success") {
          try {
            _class_private_field_get(this, _mutateOptions).onSuccess?.(action.data, variables, onMutateResult, context);
          } catch (e) {
            void Promise.reject(e);
          }
          try {
            _class_private_field_get(this, _mutateOptions).onSettled?.(action.data, null, variables, onMutateResult, context);
          } catch (e) {
            void Promise.reject(e);
          }
        } else if (action?.type === "error") {
          try {
            _class_private_field_get(this, _mutateOptions).onError?.(action.error, variables, onMutateResult, context);
          } catch (e) {
            void Promise.reject(e);
          }
          try {
            _class_private_field_get(this, _mutateOptions).onSettled?.(void 0, action.error, variables, onMutateResult, context);
          } catch (e) {
            void Promise.reject(e);
          }
        }
  ...
  var _client4, _currentResult2, _currentMutation, _mutateOptions, _updateResult, _notify2, _class5, MutationObserver;
  var init_mutationObserver = __esm({
    "node_modules/@tanstack/query-core/build/modern/mutationObserver.js"() {
      ...
      init_subscribable();
      init_utils3();
      MutationObserver = (_client4 = /* @__PURE__ */ new WeakMap(), _currentResult2 = /* @__PURE__ */ new WeakMap(), _currentMutation = /* @__PURE__ */ new WeakMap(), _mutateOptions = /* @__PURE__ */ new WeakMap(), _updateResult = /* @__PURE__ */ new WeakSet(), _notify2 = /* @__PURE__ */ new WeakSet(), _class5 = /* @__PURE__ */ function(Subscribable2) {
        "use strict";
        _inherits(_class6, Subscribable2);
        function _class6(client, options) {
          _class_call_check(this, _class6);
          var _this;
          _this = _call_super(this, _class6), _class_private_method_init(_this, _updateResult), _class_private_method_init(_this, _notify2), _class_private_field_init(_this, _client4, {
            writable: true,
            value: void 0
          ...
          _class_private_field_set(_this, _client4, client);
          _this.setOptions(options);
          _this.bindMethods();
        ...
        _create_class(_class6, [
          ...
          },
          {
            ...
            value: function setOptions(options) {
              var prevOptions = this.options;
              this.options = _class_private_field_get(this, _client4).defaultMutationOptions(options);
              if (!shallowEqualObjects(this.options, prevOptions)) {
                _class_private_field_get(this, _client4).getMutationCache().notify({
                  type: "observerOptionsUpdated",
          ...
          },
          {
            ...
            value: function mutate(variables, options) {
              ...
              _class_private_field_get(this, _currentMutation)?.removeObserver(this);
              _class_private_field_set(this, _currentMutation, _class_private_field_get(this, _client4).getMutationCache().build(_class_private_field_get(this, _client4), this.options));
    ...
    "node_modules/@tanstack/query-core/build/modern/queryCache.js"() {
      ...
      QueryCache = (_queries = /* @__PURE__ */ new WeakMap(), /* @__PURE__ */ function(Subscribable2) {
        ...
        function _class6(config = {}) {
          _class_call_check(this, _class6);
          var _this;
          _this = _call_super(this, _class6), _class_private_field_init(_this, _queries, {
            writable: true,
            value: void 0
          });
          _this.config = config;
        ...
        _create_class(_class6, [
          {
            ...
            value: function mount() {
              ...
              if (_class_private_field_get(this, _mountCount) !== 1)
                return;
              _class_private_field_set(this, _unsubscribeFocus, focusManager.subscribe((focused) => _async_to_generator(function* () {
                if (focused) {
                  yield this.resumePausedMutations();
                  _class_private_field_get(this, _queryCache).onFocus();
                }
              }).call(this)));
              _class_private_field_set(this, _unsubscribeOnline, onlineManager.subscribe((online) => _async_to_generator(function* () {
                if (online) {
                  yield this.resumePausedMutations();
                  _class_private_field_get(this, _queryCache).onOnline();
                }
              }).call(this)));
            }
          },
          ...
          },
          {
            ...
            value: function refetchQueries(filters, options = {}) {
              ...
              var promises = notifyManager.batch(() => _class_private_field_get(this, _queryCache).findAll(filters).filter((query) => !query.isDisabled() && !query.isStatic()).map((query) => {
  ...
  var init_errorBoundaryUtils = __esm({
    "node_modules/@tanstack/react-query/build/modern/errorBoundaryUtils.js"() {
      ...
      ensurePreventErrorBoundaryRetry = (options, errorResetBoundary, query) => {
        var throwOnError = query?.state.error && typeof options.throwOnError === "function" ? shouldThrowError(options.throwOnError, [
          query.state.error,
          query
      ...
      getHasError = ({ result, errorResetBoundary, throwOnError, query, suspense }) => {
        return result.isError && !errorResetBoundary.isReset() && !result.isFetching && query && (suspense && result.data === void 0 || shouldThrowError(throwOnError, [
          result.error,
          query
        ]));
      };
    ...
    "node_modules/@tanstack/react-query/build/modern/suspense.js"() {
      ...
      ensureSuspenseTimers = (defaultedOptions) => {
        if (defaultedOptions.suspense) {
          ...
          var clamp = (value) => value === "static" ? value : Math.max(value ?? MIN_SUSPENSE_TIME_MS, MIN_SUSPENSE_TIME_MS);
  ...
  function useBaseQuery(options, Observer, queryClient2) {
    ...
    var subscribed = options.subscribed !== false;
    ...
    var shouldSubscribe = !isRestoring && subscribed;
    React7.useSyncExternalStore(React7.useCallback((onStoreChange) => {
      var unsubscribe = shouldSubscribe ? observer.subscribe(notifyManager.batchCalls(onStoreChange)) : noop;
  ...
  function InstallButton(props) {
    ...
    var installationState = useMutation({
      mutationFn: ({ install }) => _async_to_generator(function* () {
  ...
  function PluginCard2(props) {
    var { display, version: version2 } = props.manifest;
    return /* @__PURE__ */ jsx(Card, {
      children: /* @__PURE__ */ jsxs(Stack, {
        spacing: 16,
        children: [
  ...
  var import_react7, import_react_native24, queryClient;
  ...
  function PluginPage(props) {
    ...
    return /* @__PURE__ */ jsx(AddonPage, {
      ...
      sortOptions: {
        ...
        "Enabled": (a, b3) => Number(b3.isEnabled()) - Number(a.isEnabled()),
        "Disabled": (a, b3) => Number(a.isEnabled()) - Number(b3.isEnabled())
      },
      safeModeHint: {
              ...
              actions: /* @__PURE__ */ jsxs(AlertActions2, {
                children: [
                  /* @__PURE__ */ jsx(AlertActionButton3, {
                    ...
                    variant: "primary",
                    onPress: () => {
                      VdPluginManager.installPlugin(url2).then(() => showToast(Strings.TOASTS_INSTALLED_PLUGIN, findAssetId("DownloadIcon"))).catch((e) => openAlert2("bunny-plugin-install-failed", /* @__PURE__ */ jsx(AlertModal3, {
  ...
  function NYakaCordFontsExtractor({ fonts: fonts2, setName }) {
          ...
          !props.name ? /* @__PURE__ */ jsxs(TableRowGroup, {
            ...
            children: [
              getCurrentTheme()?.data?.fonts && /* @__PURE__ */ jsx(TableRow, {
                ...
                onPress: () => promptActionSheet(NYakaCordFontsExtractor, fontEntries, {
                  setName
                })
              }),
              /* @__PURE__ */ jsx(TableRow, {
  ...
  // globals:react-native-webview
  var require_react_native_webview = __commonJS({
    "globals:react-native-webview"(exports, module) {
      init_asyncIteratorSymbol();
      init_promiseAllSettled();
      module.exports = require_depsModule()["react-native-webview"];
    }
  });

  // src/core/ui/settings/pages/Fonts/preview.html
  var preview_default;
  ...
  function FontPreview({ font }) {
    ...
    var props = (0, import_react9.useMemo)(() => ({
      ...
      size: fontSize * import_react_native29.PixelRatio.getFontScale(),
      color: TEXT_DEFAULT,
    ...
    return /* @__PURE__ */ jsxs(import_react_native29.View, {
      ...
      children: [
        /* @__PURE__ */ jsx(import_react_native_webview.WebView, {
        ...
        !loaded && /* @__PURE__ */ jsx(import_react_native29.View, {
          style: [
            styles3.full,
            {
              justifyContent: "center",
  ...
  var import_react9, import_react_native29, import_react_native_webview, useToken2, useStyles4;
...
Type: ${asset.type}`,
  ...
  var import_react11, import_react_native31;
  ...
  function Developer() {
    ...
    var dtConnected2 = useIsDtConnected();
    var rdtConnected2 = useIsRdtConnected();
    var styles3 = useStyles5();
    var navigation2 = NavigationNative.useNavigation();
    useProxy(settings);
            ...
            /* @__PURE__ */ jsxs(TableRowGroup, {
              ...
              children: [
                /* @__PURE__ */ jsx(TableSwitchRow, {
                  ...
                  icon: /* @__PURE__ */ jsx(TableRow.Icon, {
                    source: findAssetId("BookmarkIcon")
                  }),
                  value: !!settings.enableAutoDebugger,
                  onValueChange: (v2) => {
                    settings.enableAutoDebugger = v2;
                  }
                }),
                /* @__PURE__ */ jsx(TableRow, {
                  label: dtConnected2 ? Strings.DISCONNECT_FROM_DEBUG_WEBSOCKET : Strings.CONNECT_TO_DEBUG_WEBSOCKET,
                  subLabel: `Version ${DevToolsClient.version}`,
                  icon: /* @__PURE__ */ jsx(TableRow.Icon, {
                    source: findAssetId(dtConnected2 ? "DenyIcon" : "LinkIcon")
                  }),
                  onPress: () => dtConnected2 ? disconnectDt() : connectToDebugger(settings.debuggerUrl)
                }),
                isReactDevToolsPreloaded() && /* @__PURE__ */ jsx(Fragment, {
                  children: /* @__PURE__ */ jsx(TableRow, {
                    label: rdtConnected2 ? Strings.DISCONNECT_FROM_REACT_DEVTOOLS : Strings.CONNECT_TO_REACT_DEVTOOLS,
                    subLabel: `Version ${getReactDevToolsVersion()}`,
                    icon: /* @__PURE__ */ jsx(TableRow.Icon, {
                      source: findAssetId(rdtConnected2 ? "DenyIcon" : "StaffBadgeIcon")
                    }),
                    onPress: () => rdtConnected2 ? disconnectRdt() : connectToReactDevTools(settings.debuggerUrl)
                  })
                })
              ]
            }),
                ...
                children: [
                  ...
                  loaderConfig.customLoadUrl.enabled && /* @__PURE__ */ jsx(TableRow, {
                    label: /* @__PURE__ */ jsx(TextInput, {
                      ...
                      placeholder: "http://localhost:4040/nyakacord.js",
  ...
  var import_react_native32, import_react_native33, hideActionSheet3, showSimpleActionSheet4, openAlert5, AlertModal6, AlertActionButton6, RDT_EMBED_LINK, useStyles5;
  var init_Developer = __esm({
    "src/core/ui/settings/pages/Developer/index.tsx"() {
      ...
      RDT_EMBED_LINK = "https://github.com/revenge-mod/react-devtools-core/releases/latest/download/index.bundle";
  ...
  var import_react13, import_react_native34, initVendettaObject;
  var init_api3 = __esm({
    "src/core/vendetta/api.tsx"() {
      "use strict";
      init_asyncIteratorSymbol();
                ...
                if (props.includes("ActionSheetTitleHeader")) {
                  ...
                  return {
                    ...
                    ActionSheetContentContainer: ({ children }) => {
                      ...
                      return /* @__PURE__ */ (0, import_react13.createElement)(import_react_native34.View, null, children);
                    }
                  };
                }
              }
    ...
    onceIndexRequired = (originalRequire) => {
      if (globalThis.__fbBatchedBridge) {
        ...
        deferMethodExecution(
          ...
          // If the call is to AppRegistry, we want to defer it because it is not yet registered (NYakaCord delays it)
