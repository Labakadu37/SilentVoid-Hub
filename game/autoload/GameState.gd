...
func _build_brawlers() -> void:
	brawlers = [
		# ---- Le brawler de depart : une humaine, un fusil, rien d'exotique ------
		{
			"name": "RIKA", "rarity": "DEPART", "rarity_color": Color("35d07f"),
			"role": "COMBATTANTE", "power": 7, "trophies": 430, "unlocked": true, "price": 0,
			"skin": Color("f2c9a0"), "suit": Color("22b8c4"), "accent": Color("ffc531"),
			"hair": Color("e8722a"), "pants": Color("2c3350"),
			"weapon": "gun", "hat": "ponytail", "cape": false,
			"hp": 4200, "damage": 300, "shots": 5, "reload": 1.4, "range": 5.0, "speed": 790,
			"attack": "DOUBLE CHARGE",
			"attack_desc": "Deux gerbes de plomb. Colle a l'adversaire, tout touche.",
			"super": "DEFERLANTE",
			"super_desc": "Vide le chargeur d'un coup et repousse tout ce qui est devant.",
			"gadget": "RECUL",
			"gadget_desc": "Le tir suivant la propulse en arriere : de quoi rompre le contact.",
			"star_power": "CHARGEUR RAPIDE",
			"star_power_desc": "Recharge 15 % plus vite quand il reste une seule munition.",
			"tagline": "Entre au contact, sort avant que ca fasse mal.",
		},
		{
			...
			"hair": Color("241a4e"), "pants": Color("3b2a6b"),
			"weapon": "staff", "hat": "hood", "cape": true, "glow_eyes": true,
		...
		},
		{
			...
			"hair": Color("3b2a1a"), "pants": Color("5a3a1e"),
			"weapon": "hammer", "hat": "helmet", "cape": false,
		...
		},
		{
			...
			"skin": Color("ffd9c0"), "suit": Color("2fd9e0"), "accent": Color("f5476a"),
			"hair": Color("f5476a"), "pants": Color("24405c"),
			"weapon": "bow", "hat": "ponytail", "cape": false,
		...
		},
		{
			...
			"hair": Color("2a3050"), "pants": Color("1f6b46"),
			"weapon": "fist", "hat": "cap", "cape": false,
		...
		},
		{
			...
			"hair": Color("161a33"), "pants": Color("16304d"),
			"weapon": "staff", "hat": "crown", "cape": true,
